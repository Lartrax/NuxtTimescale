<template>
  <div
    class="w-full h-screen flex justify-center items-center py-80 bg-white dark:invert"
    :class="darkmode"
  >
    <div class="w-4/5 flex flex-col items-center gap-8">
      ...
      <div v-if="selected == 'update'" class="w-full grid grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            class="border-black border pl-1 w-full hover:bg-orange-100"
          />
        </div>
        <div>
      ...
      <!--Darkmode-->
      <button @click="darkmodeBool = !darkmodeBool">Darkmode</button>
      <!--Big table-->
      <div id="table" class="overflow-y-scroll w-full max-h-[50vh]">
        <div class="bg-white p-2 shadow-inner">
          <div
            ...
            :key="id"
            class="p-2 shadow mb-2 odd:bg-orange-200 even:bg-white"
          >
            ...
            <p v-if="item.id">
              ...
              <button
                ...
                class="text-xs shadow border border-gray-500 rounded-full ml-2 px-2 py-0.5 active:text-neutral-400 hover:bg-orange-100 hover:border-gray-300"
              >
                insert
              </button>
            </p>
      ...
      <p
        v-if="status == 'Success'"
        class="text-green-400 dark:invert"
        :class="darkmode"
      >
        {{ status }}
      </p>
      <p
        v-if="status == 'Failed'"
        class="text-red-400 dark:invert"
        :class="darkmode"
      >
        {{ status }}
      </p>
...
export default {
  data() {
    return {
      ...
      buttonTitle: "Query",
      buttonStyle:
        "border-black hover:rounded-xl hover:scale-105 hover:bg-orange-200 active:bg-orange-300",
    };
  },
  computed: {
    darkmode() {
